...
namespace TMD.SocialNetworking
{
    ...
    public class OAuthLinkedIn : oAuthBase
    {
        ...
        //These are the settings from my account!!
        private string _consumerKey = "euxq0ly6paev";
        private string _consumerSecret = "boMb1TvGuQ72hVYW";
        //private string _oAuthUserToken = "402cccdf-82d1-4a00-b336-af6ad6a431d1";
        //private string _oAuthUserTokenSecret = "c0b690a7-b52c-4c0f-bd6d-0099d1d1fdb2";
        private string _oAuthUserToken = "881bf969-46b5-4585-8b88-9d4e48086cdf";
        private string _oAuthUserTokenSecret = "e5f58125-3082-414b-8105-1d879aa61ef9";
        ...
        public string APIWebRequest(string method, string url, string postData)
        {
            ...
            this.Token = _oAuthUserToken;
            this.TokenSecret = _oAuthUserTokenSecret;
            ...
            //https://api.linkedin.com/v1/people/~?oauth_consumer_key=euxq0ly6paev&oauth_nonce=3416806&oauth_signature=Kp/AZ262l6kb9XOt7pKGXkNPgJc=&oauth_signature_method=HMAC-SHA1&oauth_timestamp=1358784698&oauth_token=402cccdf-82d1-4a00-b336-af6ad6a431d1&oauth_version=1.0


            webRequest.Headers.Add("Authorization", "OAuth realm=\"http://api.linkedin.com/\",oauth_consumer_key=\""
                + this.ConsumerKey
                + "\",oauth_token=\""
                + this.Token
